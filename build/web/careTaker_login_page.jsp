...
<html>
    <head>
        ...
        <title>CareTaker Login Page</title>
    ...
    <body>
        ...
        <main class="d-flex align-items-cente careTaker-background banner-background" style="height: 60vh">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 offset-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="CareTakerLoginServlet">
                                    ...
                                    <button type="submit" class="btn btn-primary careTaker-background">Submit</button>
                                </form>
                            </div>
                        </div>
                    </div>
