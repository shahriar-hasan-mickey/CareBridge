...
<html>
    ...
    <body >
        ...
        <main class="primary-background banner-background" style="height: 100%; padding: 5%;">
            <div class="container">
                <div class="col-md-6 offset-md-3">
                    <div class="card" style='overflow: hidden;'>
                        ...
                        <div class="card-body">
                            <form action="PatientRegisterServlet" method="POST" id="patient_registration_form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="emergencyContact" type="text" class="form-control" id="contact" placeholder="01XXXXXXXXX" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <textarea name="description" class="form-control" id="description" cols="50" rows="5" placeholder="Enter about your details, symptopms, disease (if known)"required></textarea>
                                </div>
        ...
        <script>
            ...
            var form = document.getElementById("patient_registration_form");
...
//                const url = "";
                const path = "/CareBridgeJEE/PatientRegisterServlet";
                ...
                try {
                    ...
                    if(responseData.substring(0, responseData.length-1)==="SUCCESSFULLY REGISTERED"){ //   responseData.length-1 : 1 is subtracted because there is a "\n" new line character  
                        window.location.replace("patient_login_page.jsp");
                    }
