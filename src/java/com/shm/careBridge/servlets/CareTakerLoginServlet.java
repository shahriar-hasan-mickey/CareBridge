...
//                Creating CareTaker-DAO Object
                    ...
                    CareTaker careTaker = careTakerDao.getCareTakerByEmailAndPassword(email, password);
                    if (careTaker!=null) {
                        out.println("SUCCESSFULLY LOGGED IN");
                        HttpSession session = request.getSession();
                        session.setAttribute("currentCareTaker", careTaker);
                        ...
                        out.println("Invalid Details... Try again later");
                    }
                } else {
