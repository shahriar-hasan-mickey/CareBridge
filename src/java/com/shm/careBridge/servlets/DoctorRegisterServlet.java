...
//            Fetching Data
            try {
                ...
                if (condition != null) {
                    ...
                    String dusername = jsonObj.getString("username");
                    String email = jsonObj.getString("email");
                    String password = jsonObj.getString("password");
                    String firstName = jsonObj.getString("firstName");
                    String lastName = jsonObj.getString("lastName");
                    String address = jsonObj.getString("address");
                    String specialization = jsonObj.getString("specialization") ;
                    String bio = jsonObj.getString("bio");
                    String affiliation = jsonObj.getString("affiliation");
                    String regNoMBBS = jsonObj.getString("regNoMBBS");
                    String gender = jsonObj.getString("gender");
                    

//                Doctor Object
                    Doctor doctor = new Doctor(dusername, email, password, firstName, lastName, address, specialization, bio, affiliation, regNoMBBS, regNoMBBS);

                    
//                Creating Doctor-DAO Object
                    DoctorDao doctorDao = new DoctorDao(ConnectionProvider.getConnection());
                    Boolean status = doctorDao.saveDoctor(doctor);
                    if (status) {
