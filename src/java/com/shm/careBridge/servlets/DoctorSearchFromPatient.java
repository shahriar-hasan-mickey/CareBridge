 ...
 */
public class DoctorSearchFromPatient extends HttpServlet {
...
//            String name = request.getParameter("search");
            ...
            for(Doctor doctor : doctors){
                out.println(doctor.getFullName());
            }
//            out.println(doctors);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DoctorSearchFromPatient.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
