 ...
 */
@WebServlet(name = "PatientLogoutServlet", urlPatterns = {"/PatientLogoutServlet"})
public class PatientLogoutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            PromptMessage promptMessage = new PromptMessage("Logout Successfully", "success", "alert-success");
